...
public class CharacterManipulationManager {
    ...
    public static boolean changeType(Charakter character, CharacterType newType) {
        ...
        case CHILD:
        case TEENAGER:
            character.getSpecializations().add(0, SpecializationType.UNDERAGE);
            break;
        case SLAVE:
            character.getSpecializations().add(0, SpecializationType.SLAVE);
            ...
            if (!character.getSpecializations().contains(SpecializationType.SEX)) {
                character.getSpecializations().add(1, SpecializationType.SEX);
            }
            break;
        case TRAINER:
            character.getSpecializations().add(0, SpecializationType.TRAINER);
