...
public class BathAttendant extends RunningActivity implements BusinessSecondaryActivity  {
	...
	public int getMaxAttendees() {
		return 10+getCharacters().size()*2;
	}
	...
	public void init() {
		...
		final Map<AttendType, Integer> supplyCounters=new HashMap<AttendType, Integer>();
		final Map<AttendType, Integer> demandCounters=new HashMap<AttendType, Integer>();
		final Map<Gender, Integer> genderCounters=new HashMap<Gender, Integer>();
		...
		for (Customer customer: getCustomers()) {
			...
			case BONDAGE:
				demandCounters.put(AttendType.SUBMISSIVE, demandCounters.get(AttendType.SUBMISSIVE)+25);
				demandCounters.put(AttendType.SEXY, demandCounters.get(AttendType.SEXY)+25);
				break;
			case GROUP:
				demandCounters.put(AttendType.SUBMISSIVE, demandCounters.get(AttendType.SUBMISSIVE)+Util.getInt(15, 60));
				demandCounters.put(AttendType.VAGINAL, demandCounters.get(AttendType.VAGINAL)+Util.getInt(5, 20));
				demandCounters.put(AttendType.ANAL, demandCounters.get(AttendType.ANAL)+Util.getInt(5, 20));
				demandCounters.put(AttendType.ORAL, demandCounters.get(AttendType.ORAL)+Util.getInt(5, 20));
				break;
			case MONSTER:
				demandCounters.put(AttendType.SUBMISSIVE, demandCounters.get(AttendType.SUBMISSIVE)+45);
				demandCounters.put(AttendType.SEXY, demandCounters.get(AttendType.SEXY)+45);
				break;
			case FOREPLAY:
				demandCounters.put(AttendType.FOREPLAY, demandCounters.get(AttendType.FOREPLAY)+60);
				demandCounters.put(AttendType.SEXY, demandCounters.get(AttendType.SEXY)+45);
				break;
			case VAGINAL:
				demandCounters.put(AttendType.SUBMISSIVE, demandCounters.get(AttendType.SUBMISSIVE)+10);
				demandCounters.put(AttendType.VAGINAL, demandCounters.get(AttendType.VAGINAL)+60);
				break;
			case ORAL:
				demandCounters.put(AttendType.ORAL, demandCounters.get(AttendType.ORAL)+60);
				if (customer.getGender()==Gender.FEMALE) {
					demandCounters.put(AttendType.FOREPLAY, demandCounters.get(AttendType.FOREPLAY)+40);
				} 
				else {
					demandCounters.put(AttendType.ORAL, demandCounters.get(AttendType.ORAL)+60);
				}
			...
			case ANAL:
				...
				if (customer.getGender()==Gender.FEMALE) {
					...
					demandCounters.put(AttendType.ANAL, demandCounters.get(AttendType.ANAL)+70);
				}
				demandCounters.put(AttendType.SUBMISSIVE, demandCounters.get(AttendType.SUBMISSIVE)+10);
				break;
			case TITFUCK:
				if (customer.getGender()==Gender.FEMALE) {
					...
					demandCounters.put(AttendType.TITFUCK, demandCounters.get(AttendType.TITFUCK)+60);
				}
		...
		demandCounters.put(AttendType.BASIC, getCustomers().size()*16);  // basic services are always needed
