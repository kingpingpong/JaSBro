...
public class SkillTreeItem {
    ...
    public static class CatgirlTreeStart extends SkillTreeItem {
        public CatgirlTreeStart() {
            super(Trait.HIGHCATNESSRATING, new ImageData("images/icons/perks/beast-eye.jpg"));
            Map<Trait, SkillTreeItem> map = new HashMap<Trait, SkillTreeItem>();
            map.put(Trait.HIGHCATNESSRATING, this);
            ...
            create(Trait.CATSAREASSHOLES, map, new ImageData("images/icons/perks/divergence.png"));
            
            link(Trait.HIGHCATNESSRATING, Trait.DOMESTICATED, map);
            link(Trait.HIGHCATNESSRATING, Trait.STRAYCAT, map);
            ...
            link(Trait.ALLPURRPOSE, Trait.CATSAREASSHOLES, map);
            link(Trait.CATTRACTIVE, Trait.CATSAREASSHOLES, map);
            link(Trait.CATBURGLAR, Trait.CATSAREASSHOLES, map);
    ...
    public static class SlaveSkillTreeStart extends SkillTreeItem {
        public SlaveSkillTreeStart() {
            ...
            create(Trait.CONTENT, map, new ImageData("images/icons/perks/sleepy.png"));
            ...
            link(Trait.SEXTRAINING2, Trait.TRAINING, map);
            link(Trait.BASICTRAINING2, Trait.TRAINING, map);
            link(Trait.BASICTRAINING2, Trait.CONTENT, map);
            link(Trait.SPECIALIZATIONTRAINING2, Trait.CONTENT, map);
            
            link(Trait.TRAINING, Trait.SEXTRAINING3, map);
            link(Trait.TRAINING, Trait.BASICTRAINING3, map);
            link(Trait.CONTENT, Trait.BASICTRAINING3, map);
            link(Trait.CONTENT, Trait.SPECIALIZATIONTRAINING3, map);
