...
public class TextUtil {
    ...
    public static String tNoCheck(String key) {
        return getInstance().getTextNoCheck(key, null, null);
    }
    ...
    private String getText(String key, List<? extends Person> people, Object arguments[]) {
        return getText(key, people, arguments, true);
    }
    
    private String getText(String key, List<? extends Person> people, Object arguments[], boolean error) {
