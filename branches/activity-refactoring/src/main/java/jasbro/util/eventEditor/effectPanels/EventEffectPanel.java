...
public class EventEffectPanel extends JPanel {
    private final static Logger log = Logger.getLogger(EventEffectPanel.class);
    ...
    public EventEffectPanel(WorldEventEffect worldEventEffectTmp, WorldEvent worldEventTmp, MouseListener mouseListener) {
        ...
        if (worldEventEffect != null) {
            ...
            for (WorldEventEffect worldEventEffect : worldEventEffect.getSubEffects()) {
                EventEffectPanel eventEffectPanel = new EventEffectPanel(worldEventEffect, worldEvent, mouseListener);
