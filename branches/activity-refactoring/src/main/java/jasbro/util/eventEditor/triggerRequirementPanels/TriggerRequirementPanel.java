...
public class TriggerRequirementPanel extends JPanel {
    private final static Logger log = Logger.getLogger(TriggerRequirementPanel.class);
    ...
    public TriggerRequirementPanel(TriggerRequirement triggerRequirementTmp, MouseListener mouseListener) {
        ...
        for (TriggerRequirement triggerRequirement : triggerRequirement.getSubRequirements()) {
            TriggerRequirementPanel triggerRequirementPanel = new TriggerRequirementPanel(triggerRequirement, mouseListener);
