...
public class Jasbro {
	...
	public void advanceShift() {
		...
		System.gc();
        if (log.isDebugEnabled()) {
            System.out.println("Before shift: Current memory(mb): " + (Runtime.getRuntime().totalMemory() / 1024 / 1024) + 
		...
		System.gc();
        if (log.isDebugEnabled()) {
            System.out.println("After shift: Current memory(mb): " + (Runtime.getRuntime().totalMemory() / 1024 / 1024) + 
                    " Max memory: " + (Runtime.getRuntime().maxMemory() / 1024 / 1024));
        }
	}
