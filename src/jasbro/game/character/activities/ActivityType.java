...
public enum ActivityType {
    ...
    SUNBATHE(Sunbathe.class, false), EAT(Eat.class, false), WALK(Walk.class, false),
    ...
    SUBMITTOMONSTER(SubmitToMonster.class, false, true, 10), STUDY(Study.class, false),
    ...
    MONSTERFIGHT(MonsterFight.class, true, true, 4), PUBLICIZE(Publicize.class, false, 1),
