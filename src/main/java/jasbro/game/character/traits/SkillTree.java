...
import jasbro.game.character.traits.SkillTreeItem.DominatrixTreeStart;
import jasbro.game.character.traits.SkillTreeItem.FurryTreeStart;
import jasbro.game.character.traits.SkillTreeItem.KinkySexTreeStart;
import jasbro.game.character.traits.SkillTreeItem.LegacySkillTreeStart;
...
public enum SkillTree {
	LEGACY(new LegacySkillTreeStart(), new ImageData("images/icons/perks/trainer.png")),
	...
	FURRY(new FurryTreeStart(), new ImageData("images/icons/perks/mutant.png")),
	...
	DOMINATRIX(new DominatrixTreeStart(), new ImageData("images/icons/perks/bondage.png"));
