...
public class Sex extends RunningActivity {
	...
	public List<ModificationData> getStatModifications() {
		...
		modifications.add(new ModificationData(TargetType.ALL, 1f, sexType));
		...
		if(character1.getTraits().contains(Trait.NATURAL))
			modifications.add(new ModificationData(TargetType.SINGLE, character1, 0.8f, EssentialAttributes.MOTIVATION));
		if(character2.getTraits().contains(Trait.NATURAL))
			modifications.add(new ModificationData(TargetType.SINGLE, character2, 0.8f, EssentialAttributes.MOTIVATION));
