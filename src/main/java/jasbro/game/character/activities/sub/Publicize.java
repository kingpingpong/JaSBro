...
import jasbro.game.character.activities.sub.Advertise.AdvAction;
...
public class Publicize extends RunningActivity{
	...
	public void perform() {
		...
		if(character.getTraits().contains(Trait.SAMPLINGTHEGOODS) && character.getFinalValue(SpecializationAttribute.SEDUCTION)>15 && (character.getObedience()>10 ||character.getTraits().contains(Trait.SENSITIVE)))
