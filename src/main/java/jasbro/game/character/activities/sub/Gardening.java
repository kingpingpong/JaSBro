...
public class Gardening extends RunningActivity {
	...
	public void perform() {
		...
		if(room.getGrowth()==0){//plant stuff
			...
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.cherries")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.berries")));
			options.add(new SelectionData<Integer>(1, TextUtil.t("gardening.plant.catnip")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.oranges")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.shrooms")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.peaches")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.vines")));
			options.add(new SelectionData<Integer>(2, TextUtil.t("gardening.plant.weed")));
