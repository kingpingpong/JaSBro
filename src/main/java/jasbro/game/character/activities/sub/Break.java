...
public class Break extends RunningActivity {
	...
	public List<ModificationData> getStatModifications() {
		...
		obedienceMod += trainer.getFinalValue(SpecializationAttribute.DOMINATE) / 50.0;
		...
		modifications.add(new ModificationData(TargetType.SLAVE, -1.3f, EssentialAttributes.MOTIVATION));
		modifications.add(new ModificationData(TargetType.TRAINER, 1.3f, EssentialAttributes.MOTIVATION));
