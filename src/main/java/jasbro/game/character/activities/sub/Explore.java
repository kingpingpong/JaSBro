...
public class Explore extends RunningActivity {
	...
	public List<ModificationData> getStatModifications() {
		...
		if (getCharacter().getSpecializations().contains(SpecializationType.FIGHTER)) {
			modifications.add(new ModificationData(TargetType.ALL, 1.1f, SpecializationAttribute.VETERAN));
		}
		else {
			modifications.add(new ModificationData(TargetType.ALL, 0.1f, SpecializationAttribute.VETERAN));
		}
