...
public class WorldEvent implements TriggerParent, Serializable {
	private final static Logger log = LogManager.getLogger(WorldEvent.class);
	private String id;
	...
	public void handleEvent(MyEvent e) {
		...
		if (e.getType() == EventType.HEALTHZERO
				&& getProtectedCharacters().contains(((AttributeChangedEvent) e).getAttribute().getCharacter())) {
			e.setCancelled(true);
		}
	}
