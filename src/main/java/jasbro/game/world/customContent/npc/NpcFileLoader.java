...
private final static Logger log = Logger.getLogger(NpcFileLoader.class);
            ...
            for (TFile file : enemyFolder.listFiles()) {
                if (file.isFile() && file.getName().equals(ENEMYFILENAME)) {
                    try {
                        ...
                        log.error("Error loading enemy file: " + file.getName(), e);
                    }
                }
    ...
    private ComplexEnemyTemplate loadEnemyTemplate(TFile file) {
