...
public class IngredientItemEffectPanel extends JPanel {
	protected boolean selected = false;
	protected UsableItemEffect itemEffect;
	protected JPanel contentPanel;
	protected JPanel dataPanel;
	
	public IngredientItemEffectPanel() {
	...
	public void setItemEffect(UsableItemEffect usableItemEffect) {
		this.itemEffect = usableItemEffect;
		try {
			Class<? extends JPanel> panelClass = getItemEffect().getType().getItemEffectPanelClass();
			if (panelClass != null) {
				dataPanel = panelClass.getConstructor(UsableItemEffect.class).newInstance(getItemEffect());
			}
			else {
	...
	public void addPanel(IngredientItemEffectPanel usableItemEffectPanel) {
		contentPanel.add(usableItemEffectPanel);
	}
	
	public void removePanel(IngredientItemEffectPanel usableItemEffectPanel) {
