...
public class UsableItemEffectPanel extends JPanel {
	protected boolean selected = false;
	protected UsableItemEffect itemEffect;
	protected JPanel contentPanel;
	protected JPanel dataPanel;
	
	public UsableItemEffectPanel() {
	...
	public void addPanel(UsableItemEffectPanel usableItemEffectPanel) {
		contentPanel.add(usableItemEffectPanel);
	}
	
	public void removePanel(UsableItemEffectPanel usableItemEffectPanel) {
