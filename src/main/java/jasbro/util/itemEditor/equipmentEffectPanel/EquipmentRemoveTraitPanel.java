...
import jasbro.game.items.equipmentEffect.EquipmentRemoveTrait;
...
public class EquipmentRemoveTraitPanel extends JPanel {
	private EquipmentRemoveTrait itemEffect;
	
	public EquipmentRemoveTraitPanel(EquipmentEffect equipmentEffect) {
		...
		this.itemEffect = (EquipmentRemoveTrait)equipmentEffect;
