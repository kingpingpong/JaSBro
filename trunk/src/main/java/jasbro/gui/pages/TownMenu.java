...
import jasbro.gui.pages.subView.AuctionHousePanel;
...
public class TownMenu extends MyImage {
	...
	public TownMenu() {
        ...
        if (Jasbro.getInstance().getData().getTime() != Time.NIGHT) {
	        btnAuctionHouse = new JButton("Auction House");
	        addToMenuPanel(btnAuctionHouse);
	        btnAuctionHouse.addActionListener(new  ActionListener() {
	            
	            @Override
	            public void actionPerformed(ActionEvent e) {
	                setContentPanel(new AuctionHousePanel(), new ImageData("images/backgrounds/auctionHouse.jpg"));
	            }
	        });
