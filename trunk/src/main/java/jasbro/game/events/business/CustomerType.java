...
public enum CustomerType {
    ...
    public static Customer generateCustomer(CustomerType customerType) {
    	...
    	switch (customerType) {
    	case CELEBRITY:
            customer = new Customer(CustomerType.CELEBRITY, Util.getInt(12000, 15000), -150, 50);
            break;
    	case LORD:
            customer = new Customer(CustomerType.LORD, Util.getInt(2000, 5000), -60, 10);
            break;
    	case MINORNOBLE:
            customer = new Customer(CustomerType.MINORNOBLE, Util.getInt(900, 2000), -35, 3);
            break;
    	case BUSINESSMAN:
